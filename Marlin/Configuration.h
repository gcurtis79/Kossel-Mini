...
#define STRING_CONFIG_H_AUTHOR "Greg Curtis" // Who made the changes.
...
//#define MACHINE_UUID "b8045df9-88e8-4224-bbc9-99196a278691"
...
#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 150, 30 } // Angles for E0, E1[, E2, E3]
  #if EXTRUDERS > 3
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 241.30        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 298.6             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 149.64              // (mm) Get this value from G33 auto calibrate
...
#define E0_STEPS_PER_MM 180 // Was 84 with a4988 drivers (1/16 microstepping)

// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, E0_STEPS_PER_MM }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -3.5 }
